package com.example.boilerplate.api.auth.controller;
...
import com.example.boilerplate.api.auth.service.AuthService;
...
public class AuthController {
    ...
    @Auth(userRoles = {UserRole.USER, UserRole.ADMIN})
